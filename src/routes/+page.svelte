...
<img alt="The AMC Trainer logo" id="logo" src="/img/logo_{$settings.logoColor}.png" />

<div id="body" class="body">
	<button
		type="button"
		onclick={() => window.location.href = '/play'}
		style="position: relative; width: 15rem; height: 5rem; left: 50%; transform: translateX(-50%); border-radius: 1rem; font-size: 1.6em;"
		class="button"
		data-hover="Play"
	>
		Play
	...
	<h2 class="h2">Who?</h2>
	<p>For <b>THE</b> math-enthusiast-tech savvy-4.8 GPA-overachiever-future doctor and entrepreneur 💥 ℼ ∫ 🥇</p>

	<h2 class="h2">Why? 💹</h2>
	<p>
		We created this <b>AMAZING</b> math website practice tool to make <b>YOU</b> become the star 🌟 of your family and maybe your whole state! 🏆
		<br /><br />
		If you just simply want to do <b>BETTER</b> on the next AMC test, then this is the website for you! 🥇
	</p>

	<h2 class="h2">What? 📈</h2>
	<p>A <b>FREE</b> interactive 👆 trainer practice tool which generates math problems to help study for your specific AMC level (such as AMC 8/10/12/AIME). Great practice tool for math competition preparation!</p>
	...
	<p>
		...
		<a target="_blank" href="https://artofproblemsolving.com/community/c1967976h2362114p19241124">here</a>.
		<br />
		Happy 😎😃 MATHING 🧮 ➖👨‍🔬 ℼ ➗ ➕
		<br /><br />
